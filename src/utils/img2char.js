...
if( PATH.basename( process.argv[ 1 ] ).toLowerCase() == 'img2char.js' )
{
	...
	console.log( 'IMG2CHAR v1.0-3 by Baptiste Bideaux.' );
	console.log( '------------------------------------' );
	console.log( ' ' );
...
function checkParams()
{
	...
	if( m != 'cpc' && m != 'atarist' && m != 'thomson' && m != 'c64' && m != 'vg5000' && m != 'exelvision' )
	{	
		console.log( 'ERROR: Invalid value in "-m" argument. "CPC", "VG5000", "THOMSON", "EXELVISION" or "C64" waiting.' );
		return false;
	}
	return true;
}
